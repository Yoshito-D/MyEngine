...
namespace GameEngine {
    ...
    nlohmann::json RendererModule::ToJson() const {
        ...
        j["ribbonEnabled"] = ribbonEnabled_;
        j["ribbonWidth"] = ribbonWidth_.ToJson();
        j["ribbonMaxPoints"] = ribbonMaxPoints_;
        j["ribbonMinDistance"] = ribbonMinDistance_;
    ...
    void RendererModule::FromJson(const nlohmann::json& j) {
        ...
        if (j.contains("ribbonEnabled")) SetRibbonEnabled(j["ribbonEnabled"]);
        if (j.contains("ribbonWidth")) {
            if (j["ribbonWidth"].is_object()) ribbonWidth_.FromJson(j["ribbonWidth"]);
            else ribbonWidth_ = RandomFloat(j["ribbonWidth"].get<float>());
        }
        if (j.contains("ribbonMaxPoints")) SetRibbonMaxPoints(j["ribbonMaxPoints"]);
        if (j.contains("ribbonMinDistance")) SetRibbonMinDistance(j["ribbonMinDistance"]);
